...
CREATE SCHEMA IF NOT EXISTS `ERD_MOP` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `ERD_MOP` ;

-- -----------------------------------------------------
-- Table `ERD_MOP`.`church`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ERD_MOP`.`church` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ERD_MOP`.`employee` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ERD_MOP`.`person` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ERD_MOP`.`position` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ERD_MOP`.`marriage` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_marriage_Employee1`
    ...
    REFERENCES `ERD_MOP`.`employee` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ERD_MOP`.`confirmation` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ERD_MOP`.`baptismal` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ERD_MOP`.`bapGodParent` (
  ...
  CONSTRAINT `fk_bapGodParent_baptismal1`
    ...
    REFERENCES `ERD_MOP`.`baptismal` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `ERD_MOP`.`confGodParent` (
  ...
  CONSTRAINT `fk_confGodParent_confirmation1`
    ...
    REFERENCES `ERD_MOP`.`confirmation` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `ERD_MOP`.`marGodParent` (
  ...
  CONSTRAINT `fk_marGodParent_marriage1`
    ...
    REFERENCES `ERD_MOP`.`marriage` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
