...
class BapGodparentController extends Controller
{
	/**
	...
	{
		$model=new BapGodparent('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['BapGodparent']))
			$model->attributes=$_GET['BapGodparent'];
	 ...
	 * @return BapGodparent the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=BapGodparent::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param BapGodparent $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bap-godparent-form')
		{
